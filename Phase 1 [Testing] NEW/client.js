...
function applyFilters() {
    ...
    let filteredCourses = allCourses.filter(course => {
        ...
        // NEW: Check if student has approved registration in any class
        const hasApprovedRegistration = course.classes?.some(cls => 
        ...
        return matchesSearch && 
               ...
               hasActiveClasses && 
               !isCompleted &&
               !hasApprovedRegistration; // NEW exclusion
    });
...
function addClassForm() {
    ...
    classForm.innerHTML = `
        ...
        <div class="form-group">
            ...
            <input type="number" class="class-capacity" min="3" value="20" required>
        </div>
